...
// hooks and DOM measurement, so the App Router needs the directive.
// NOTE: this component renders its own <form>. Never nest it inside
// another form — use its onSubmit callback instead.
// Re-running `shadcn add` for this component will overwrite both notes.
import {
  useEffect,
  useId,
  useLayoutEffect,
