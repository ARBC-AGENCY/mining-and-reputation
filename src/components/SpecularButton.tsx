...
// useRef/useEffect + WebGL, so the App Router needs the directive.
// Re-running `shadcn add` for this component will overwrite it.
...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      // Local fix: `steer` already tests pointerAngle != null, but TypeScript
      // cannot narrow through the intermediate boolean under `strict`.
